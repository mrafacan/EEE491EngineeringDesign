...
\begin{document}
	...
	\begin{figure}[H]
		...
		\includegraphics[scale = 0.25]{images/diagramofsystem.jpg}\\[0.5 cm]	
	...
	\begin{figure}[H]
		\centering
		\label{gann}
		\includegraphics[scale = 0.2]{gann.png}\\[0.5 cm]
	...
	\subsubsection*{Estimating Design}
	\begin{table}[h!]
		\centering
		\resizebox{0.75\textwidth}{!}{%
			\begin{tabular}{|l|r|r|r|r|r|r}
				...
				Jumper \&  Sockets  \& Soldering Materials & 1 & 400 TL & 400 TL \\	\hline
				& & & 1466.66 TL\\ \hline
	...
	\subsubsection*{Development and Manufacturing Costs}
	\begin{table}[h!]
		\centering
		\resizebox{0.75\textwidth}{!}{%
			\begin{tabular}{|l|r|r|r|r|}
				\hline
				\textbf{Service} & \textbf{Provider}  & \textbf{Charge} \\
				\hline
				Embedded	Software Update and Maintenance &  Bora Bostanoglu & FREE \\ \hline
				UI Update and Maintenance     &  Mert Afacan & FREE \\ \hline
				Hardware \& Soldering Support    &  Eren Öztürk & FREE \\ \hline 	
				Algorithm Design and Updates & Bora Bostanoğlu & FREE \\ \hline
				QT Creator License & QT  & 15000 TL\\ \hline
				Version Control System & GitHub & 1500TL \\ \hline
		\end{tabular} }
		\caption{Development and Manufacturing Costs }
	\end{table}
	...
	\begin{figure}[H]
		...
		\label{Level22 Design Of The System}
		\includegraphics[scale = 0.35]{images/breakeven.png}	
		\caption{Break-Even Cost Analysis} 		
	\end{figure}
 \columnbreak { \scriptsize
Total Cost = Fixed cost + n \cdot \left(\frac{{\text{Variable Cost}}}{{\text{unit}}}\right) = 16500 + n \cdot 1466,66 \\
Revenue = n \cdot \left(\frac{{\text{Sale Price}}}{{\text{Unit}}}\right) = n \cdot 7300 \\ 
n \cdot \left(\frac{{\text{Sale Price}}}{{\text{Unit}}}\right) = \text{Fixed Cost} + n \cdot \left(\frac{{\text{Variable Cost}}}{{\text{Unit}}}\right) \\
n \cdot 7300 = 16500 + n \cdot 1466,66 \\
n = 3 \text{ units}
...
\end{multicols}
	...
	\begin{figure}[H]
		\centering
		\label{Meeting4}
		\includegraphics[scale = 0.25]{images/meet4_02.01.2024.png}\\[0.5 cm]
		
	\end{figure}
	\begin{figure}[H]
		\centering
		\label{Meeting5}
		\includegraphics[scale = 0.25]{images/meet4_10.01.2024.png}\\[0.5 cm]			
	\end{figure}
	\begin{figure}[H]
		\centering
		\label{Meeting3}
		\includegraphics[scale = 0.25]{images/meet6_12.01.2024.png}\\[0.5 cm]			
	\end{figure}
